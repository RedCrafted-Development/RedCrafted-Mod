...
public class Command_pie extends FreedomCommand
{
    ...
    public static final String CAKE_LYRICS = "Baked fresh for you by grandpa.";
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        heldItemMeta.setDisplayName((new StringBuilder()).append(ChatColor.GRAY).append("Fresh ").append(ChatColor.GOLD).append("Pie").toString());
